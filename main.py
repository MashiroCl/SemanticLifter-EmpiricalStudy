...
def analysis_within_method_ref(refactoringminer, repository_path, output_repository_path, log_path):
    ...
    commitInfos = extract_within_method_refactor_commit(repository_path, output_repository_path.joinpath(repo.name),
                                                        output_json.joinpath("withinmethod_refactor_commits.json"))
...
def command():
    ...
    parser.add_argument('--log', help="path for the log file")
